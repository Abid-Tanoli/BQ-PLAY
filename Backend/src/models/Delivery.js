...
const deliverySchema = new mongoose.Schema({
  ...
  wicketType: { type: String, enum: ["bowled", "caught", "lbw", "runOut", "run_out", "stumped", "hitWicket", "hit_wicket", "retired hurt", "retiredOut", "obstructing the field", "obstructingField", null] },
