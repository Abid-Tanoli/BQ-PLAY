          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
            ...
            <div className="p-6">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  <label className="text-[10px] font-black uppercase text-slate-400 block mb-1.5 ml-1">Primary Role</label>
                  <input {...register("role")} placeholder="e.g. Batter / Bowler" className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none font-bold text-slate-800 transition-all" />
                </div>
                <div>
                  <label className="text-[10px] font-black uppercase text-slate-400 block mb-1.5 ml-1">Team Assignment</label>
               ...
               {players.map((p) => (
                 <div key={p._id} className="group relative bg-white border border-slate-100 rounded-3xl p-6 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
                    ...
                    <div className="flex gap-2">
                       <button onClick={() => handleEdit(p)} className="flex-1 py-2.5 bg-slate-50 hover:bg-blue-600 hover:text-white text-slate-400 font-bold text-[9px] uppercase tracking-widest rounded-xl transition-all border border-slate-100">Profile</button>
